export const getLetterGrade = (grade: number) => {
    ...
    if (grade >= 62.5 && grade < 66.5) {
        return "D";
    }
    if (grade >= 66.5 && grade < 70) {
        return "D+";
    }
    // C
    ...
    if (grade >= 72.5 && grade < 76.5) {
        return "C";
    }
    if (grade >= 76.5 && grade < 80) {
        return "C+";
    }
    // B
    ...
    if (grade >= 82.5 && grade < 86.5) {
        return "B";
    }
    if (grade >= 86.5 && grade < 90) {
        return "B+";
    }
    // A
